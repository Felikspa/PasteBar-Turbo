...
export default function UserPreferences() {
  ...
  const { returnRoute, isWindows, isMacOSX } = useAtomValue(uiStoreAtom)
                      ...
                      <CardContent>
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <Switch
                              checked={isTrayIconHidden}
                              onCheckedChange={() => {
                                setIsTrayIconHidden(!isTrayIconHidden)
                              }}
                            />
                          </div>
