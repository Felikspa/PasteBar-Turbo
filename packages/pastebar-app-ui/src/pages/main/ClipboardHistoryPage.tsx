              ...
              <AutoSize disableWidth>
                {({ height }: { height: number }) =>
                  ...
                  height > 0 && (
                    ...
                    >
                      <Box
                        className="flex flex-row bg-white dark:bg-[#0f0f11] rounded-md p-0 items-center h-[40px] mb-3"
            ...
            {!showLargeViewHistoryId.value && !showLargeViewClipId.value ? (
              <Box
                className={`${
                  ...
                  !isSimplifiedLayout
                    ? 'bg-white border-gray-200 dark:bg-[#0f0f11] dark:border-gray-800 dark:shadow-gray-700/[.7]'
                    : ''
                }`}
              >
                <AutoSize disableWidth>
              ...
              <Box
                className={`${
                  ...
                  isSimplifiedLayout
                    ? 'bg-white rounded-xl dark:bg-[#0f0f11] dark:border-gray-700 dark:shadow-gray-700/[.7]'
                    : 'bg-red-50'
                }`}
              >
                <AutoSize disableWidth>
