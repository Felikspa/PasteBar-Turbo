              ...
              {({ height }: { height: number }) =>
                ...
                currentCollectionId && (
                  ...
                  >
                    {data.length > 0 ? (
                      <Box
                        className="flex flex-row bg-white dark:bg-[#0f0f11] rounded-md p-0 items-center h-[40px] mb-2"
                        id="menu-find_tour"
                      >
                        <Input
                          ...
                          className="text-md ring-offset-0 bg-white dark:bg-[#0f0f11] border-r-0 border-t-0 border-b-0"
                        />
                      </Box>
                    ) : (
                      menuFullyLoaded &&
          ...
          {menuFullyLoaded && (
            <Box
              className={`${
                ...
                !isSimplifiedLayout
                  ? 'bg-white border-gray-200 dark:bg-[#0f0f11] dark:border-gray-800 dark:shadow-slate-700/[.7]'
                  : ''
              }`}
            >
              <AutoSize disableWidth>
